...
public class Test1 {
    public static void main(String[] args) {
        ...
        System.out.println(getMaxStr(input1));

        // TODO 输出3个最长对称字符串：aba/aca/ada
        String input2 = "abcda";
        System.out.println(getMaxStr(input2));

        // TODO 输出2个最长对称字符串：pop/upu，不会输出特殊字符的对称字符串p-p
        String input3 = "pop-upu";
        System.out.println(getMaxStr(input3));
    }

    public static String getMaxStr(String input) {
        String[] prepare = stringFilter(input);
        StringBuffer sb = new StringBuffer();
        for (String str : prepare) {
            String result = getLCS(str);
            sb.append(result);
            sb.append("/");
        }
    ...
    public static String getLCS(String input) {
